...
if (length(valid_genes) > 0) {
  ...
  ggsave("viral_expression_dotplot_cow_MANUAL.pdf", p_manual_dot, width = 14, height = calc_height, limitsize = FALSE)
